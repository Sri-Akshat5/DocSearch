...
const SECRET_KEY = process.env.SECRET_KEY || "AnyKeyWithValue"; 
...
router.post("/register",
    ...
    async (req, res) => {
        try {
            ...
            await db.promise().execute("INSERT INTO users (name, email, password) VALUES (?, ?, ?)", [name, email, hashedPassword]);
